...
import { PostModel } from '../../../../back-end/src/models/postModel';
...
const Post: React.FC<{post: PostModel, minWidth: string, maxWidth: string, padding: string}> = ({post, minWidth, maxWidth, padding}) => {
    ...
    return (
        <Grid container direction='row' minWidth={minWidth} maxWidth={maxWidth} padding={padding}>
            <Grid item xs={1.5}>
